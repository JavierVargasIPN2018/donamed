...
import { FileText, Clock, CheckCircle, XCircle, Package, Phone, Calendar } from "lucide-react";
import { useMyRequests, useCancelRequest } from "@/client/modules/matchmaking/hooks/use-medication-requests.hook";
                        ...
                        {filteredRequests.length === 0 ? (
                            ...
                            <div className="space-y-4">
                                {filteredRequests.map((request) => {
                                    ...
                                    const urgencyConf = urgencyConfig[request.urgencyLevel as keyof typeof urgencyConfig];
                                        ...
                                        <Card key={request.id}>
                                                    ...
                                                    <div className="space-y-2 flex-1">
                                                        <div className="flex items-center gap-2 flex-wrap">
                                                            <CardTitle className="text-lg">
                                                                {request.medication?.brand || request.medication?.activeSubstance}
                                                            </CardTitle>
                                                            <Badge className={statusConf.color}>
                                                                <StatusIcon className="h-3 w-3 mr-1" />
                                                                {statusConf.label}
                                                            </Badge>
                                                            <Badge variant="outline" className={urgencyConf.color}>
                                            ...
                                            <CardContent className="space-y-4">
                                                    ...
                                                    <div className="flex items-center gap-2 text-muted-foreground">
                                                        ...
                                                        <span>
                                                            ...
                                                            <span className="font-medium text-foreground">
                                                                {request.medication?.donor?.name || "Desconocido"}
                                                            </span>
                                                        </span>
                                                    </div>
                                                ...
                                                <div className="pt-3 border-t">
                                                    <h4 className="text-sm font-medium mb-2">Tu situación médica:</h4>
